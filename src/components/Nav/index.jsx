...
export const Nav = () => {
  ...
  return (
    ...
    <ul className={`absolute bg-slate-600 w-full h-100svh top-0 left-0 ${isOpen ? 'translate-y-0':'-translate-y-110svh '} transition-all ease-out duration-500 flex flex-col align-middle  justify-evenly`}>
