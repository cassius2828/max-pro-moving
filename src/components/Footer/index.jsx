const navigation = {
  ...
  company: [
    ...
    { name: "Detailed Quote", href: "/#detailed-quote" },
      ...
      >
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.loctions.map((item) => (
                    <li key={item.name}>
                      <a
                        href={item.href}
                        className="text-lg text-gray-200 hover:text-gray-100"
                      >
                        {item.name}
                      </a>
                    </li>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-xl font-semibold text-gray-100">Company</h3>
                <ul role="list" className="mt-6 space-y-4">
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-xl font-semibold text-gray-100">Legal</h3>
                <ul role="list" className="mt-6 space-y-4">
        ...
        {/* <div className="mt-16 border-t border-gray-100/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
          ...
          <form className="mt-6 sm:flex sm:max-w-md lg:mt-0">
            ...
            <input
              ...
              autoComplete="email"
              className="w-full min-w-0 rounded-md bg-white px-3 py-1.5 text-base text-gray-100 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-200 sm:w-56 sm:text-lg"
            />
